...
require 'vendor/autoload.php'; // Cargar PHPMailer automáticamente
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT id_user FROM usuarios WHERE email = :email");
        ...
        if ($stmt->rowCount() === 1) {
            ...
            try {
                ...
                $mail->SMTPAuth = true;
                $mail->Username = 'cgimenezzz17@gmail.com'; // Tu correo
                $mail->Password = 'ndqr lukd ryzm ncfc'; // Contraseña de aplicación
