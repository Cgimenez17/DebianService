                                    ...
                                    if (isset($_GET['token'])) {
                                        ...
                                        try {
                                            ...
                                            if ($stmt->rowCount() === 1) {
                                                ...
                                                echo '<div class="text-center text-danger">El enlace ha expirado o es inválido.</div>';
                                            }
                                        } catch (PDOException $e) {
                                            echo '<div class="text-center text-danger">Error en la conexión: ' . $e->getMessage() . '</div>';
                                        }
                                    }
                                    ?>
                                    <hr>
