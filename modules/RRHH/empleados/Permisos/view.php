            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Registrar Permisos</h1>
                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <form role="form" class="form-horizontal" action="proses.php" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="txt_permiso">Ingrese el motivo por el cual solicita el permiso</label>
                                        <input type="text" class="form-control" id="txt_permiso" name="txt_permiso" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="fecha_permiso">Permiso desde:</label>
                                        <input type="date" class="form-control" id="fecha_permiso" name="fecha_permiso" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="fecha_permisofin">Permiso hasta:</label>
                                    ...
                                    <script>
                                        ...
                                        function setCurrentDateTime() {
                                            const now = new Date();
                                            const offset = -3; // UTC-3 para Paraguay
                                            now.setHours(now.getHours() + offset);

                                            const localDateTime = now.toISOString().slice(0, 16); // YYYY-MM-DDTHH:mm
                                            document.getElementById('fec_ingreso').value = localDateTime;
                                        }
                                    ...
                                    <button type="submit" name="guardarEntrada" class="btn btn-primary btn-block">Solicitar permiso</button>
                                ...
                                if (!empty($_GET['alert'])) {
                                    switch ($_GET['alert']) {
                                        ...
                                        case 'errorDuplicatedEntrada':
                                            echo "<div class='alert alert-warning'>Ya has registrado un permiso en esa fecha.</div>";
                                            break;
                                        case 'NotAnEmployee':
