                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                ...
                                <form role="form" class="form-horizontal" action="proses.php" method="POST"
                                    ...
                                    <label for="fec_ingreso">Fecha y hora</label>
                                        <input type="datetime-local" class="form-control" id="fec_ingreso" name="fec_ingreso" readonly>
                                    ...
                                    <button type="submit" name="guardarEntrada" class="btn btn-primary btn-block">Registrar asistencia</button>
                                    <button type="submit" name="guardarSalida" class="btn btn-primary btn-block">Registrar Salida</button>
                                </form>
