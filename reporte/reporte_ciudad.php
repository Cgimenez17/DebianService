...
class BasePDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100, 10, convertir('REPORTE DE CIUDADES'), 0, 1, 'C', 0);
        $this->Ln(7);
    ...
    $this->Cell(70, 10, convertir('Ciudad'), 1, 0, 'C', true); // Ancho: 70
    $this->Cell(100, 10, convertir('Departamento'), 1, 1, 'C', true); // Ancho: 100
