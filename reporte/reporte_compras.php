...
class BasePDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100, 10, convertir('REPORTE DE COMPRAS'), 0, 1, 'C', 0);
        $this->Ln(7);
        ...
        $this->Cell(35, 10, convertir('Proveedor'), 1, 0, 'C', true);
        $this->Cell(25, 10, convertir('Nro Factura'), 1, 0, 'C', true);
        $this->Cell(25, 10, convertir('Fecha'), 1, 0, 'C', true);
        $this->Cell(20, 10, convertir('Estado'), 1, 0, 'C', true);
        $this->Cell(27, 10, convertir('Deposito'), 1, 0, 'C', true);
        $this->Cell(17, 10, convertir('Hora'), 1, 0, 'C', true);
        $this->Cell(17, 10, convertir('Total'), 1, 0, 'C', true);
        $this->Cell(30, 10, convertir('Usuario'), 1, 1, 'C', true);
