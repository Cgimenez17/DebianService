...
class BasePDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100, 10, convertir('REPORTE DE PRODUCTOS'), 0, 1, 'C', 0);
        $this->Ln(7);
        ...
        $this->Cell(50, 10, convertir('Tipo Producto'), 1, 0, 'C', true);
        $this->Cell(40, 10, convertir('Unidad Medida'), 1, 0, 'C', true);
        $this->Cell(50, 10, convertir('Producto'), 1, 0, 'C', true);
        $this->Cell(30, 10, convertir('Precio'), 1, 1, 'C', true);
    }
