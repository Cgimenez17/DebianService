...
class BasePDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100, 10, convertir('REPORTE DE DEPARTAMENTOS'), 0, 1, 'C', 0);
        $this->Ln(7);
        ...
        $this->SetX(60); // Ajusta este valor según el ancho de tu página y tabla
        $this->Cell(50, 10, convertir('Cod.'), 1, 0, 'C', true);
        $this->Cell(50, 10, convertir('Departamento'), 1, 1, 'C', true);
